...
class Ui_frm_step_edit(object):
    def setupUi(self, frm_step_edit):
        ...
        self.tab_step.setGeometry(QRect(10, 50, 401, 401))
...
"")
        ...
        self.grb_action.setGeometry(QRect(10, 180, 381, 191))
        ...
        self.btn_run.setGeometry(QRect(250, 460, 71, 31))
