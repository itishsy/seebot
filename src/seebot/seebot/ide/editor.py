...
class Ui_frm_step_edit(object):
    def setupUi(self, frm_step_edit):
        ...
        self.tab_step.setGeometry(QRect(10, 50, 401, 411))
        ...
        self.tab_step.setStyleSheet(u"border-color: rgb(170, 255, 255);\n"
"")
        self.tab_step.setTabPosition(QTabWidget.North)
        self.tab_step.setTabShape(QTabWidget.Rounded)
        ...
        self.grb_target.setStyleSheet(u"")
        self.formLayoutWidget_3 = QWidget(self.grb_target)
        self.formLayoutWidget_3.setObjectName(u"formLayoutWidget_3")
        self.formLayoutWidget_3.setGeometry(QRect(20, 20, 341, 141))
        ...
        self.grb_action.setGeometry(QRect(10, 190, 381, 191))
        self.grb_action.setStyleSheet(u"")
        self.formLayoutWidget_4 = QWidget(self.grb_action)
        self.formLayoutWidget_4.setObjectName(u"formLayoutWidget_4")
        self.formLayoutWidget_4.setGeometry(QRect(20, 20, 341, 161))
        ...
        self.formLayoutWidget.setGeometry(QRect(20, 20, 341, 158))
        ...
        self.formLayoutWidget_2.setGeometry(QRect(20, 20, 341, 121))
        ...
        self.btn_run.setGeometry(QRect(10, 470, 71, 31))
        self.btn_save = QPushButton(frm_step_edit)
        self.btn_save.setObjectName(u"btn_save")
        self.btn_save.setGeometry(QRect(260, 470, 75, 31))
        self.fid_status = QCheckBox(frm_step_edit)
        self.fid_status.setObjectName(u"fid_status")
        self.fid_status.setGeometry(QRect(360, 50, 61, 19))
        font = QFont()
        font.setPointSize(10)
        self.fid_status.setFont(font)
        self.fid_stepName = QLineEdit(frm_step_edit)
        self.fid_stepName.setObjectName(u"fid_stepName")
        self.fid_stepName.setGeometry(QRect(10, 10, 401, 31))
        self.fid_stepName.setStyleSheet(u"border-color: rgb(170, 255, 255);")
        self.btn_close = QPushButton(frm_step_edit)
        self.btn_close.setObjectName(u"btn_close")
        self.btn_close.setGeometry(QRect(340, 470, 71, 31))
    ...
    def retranslateUi(self, frm_step_edit):
        ...
        self.btn_run.setText(QCoreApplication.translate("frm_step_edit", u"\u8fd0\u884c\u6b65\u9aa4", None))
        ...
        self.btn_close.setText(QCoreApplication.translate("frm_step_edit", u"\u53d6\u6d88", None))
    # retranslateUi
