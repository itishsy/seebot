...
class Ui_frm_index(object):
    ...
    def retranslateUi(self, frm_index):
        ...
        self.cmb_server.setItemText(0, QCoreApplication.translate("frm_index", u"https://rpaadmin.seebon.com", None))
        self.cmb_server.setItemText(1, QCoreApplication.translate("frm_index", u"http://192.168.0.99:9999", None))

        self.cmb_server.setCurrentText(QCoreApplication.translate("frm_index", u"https://rpaadmin.seebon.com", None))
