...
class Ui_frm_index(object):
    ...
    def retranslateUi(self, frm_index):
        ...
        self.cmb_server.setItemText(1, QCoreApplication.translate("frm_index", u"http://127.0.0.1:9090", None))
        self.cmb_server.setItemText(2, QCoreApplication.translate("frm_index", u"http://192.168.0.99:9999", None))
        self.cmb_server.setItemText(3, QCoreApplication.translate("frm_index", u"https://rpaadmin.seebon.com", None))
