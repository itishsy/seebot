...
class Ui_frm_flow_config(object):
    def setupUi(self, frm_flow_config):
        ...
        frm_flow_config.resize(1068, 696)
        ...
        self.trw_steps = QTreeWidget(self.groupBox_2)
        font = QFont()
        font.setItalic(True)
        __qtreewidgetitem1 = QTreeWidgetItem()
        __qtreewidgetitem1.setFont(1, font);
        __qtreewidgetitem1.setBackground(1, QColor(170, 85, 127));
        __qtreewidgetitem1.setText(0, u"\u6b65\u9aa4");
        self.trw_steps.setHeaderItem(__qtreewidgetitem1)
        self.trw_steps.setObjectName(u"trw_steps")
        self.trw_steps.setGeometry(QRect(0, 20, 471, 541))
        self.trw_steps.setFrameShape(QFrame.StyledPanel)
        self.trw_steps.setEditTriggers(QAbstractItemView.NoEditTriggers)
        self.trw_steps.setDragEnabled(True)
        self.trw_steps.setDragDropMode(QAbstractItemView.DragOnly)
        self.trw_steps.setSelectionMode(QAbstractItemView.ExtendedSelection)
    ...
    def retranslateUi(self, frm_flow_config):
        ...
        ___qtreewidgetitem = self.trw_steps.headerItem()
        ___qtreewidgetitem.setText(1, QCoreApplication.translate("frm_flow_config", u"\u6307\u4ee4", None));
